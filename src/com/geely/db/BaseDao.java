...
* 
* <p>Title: 好爸妈客户端</p>
* <p>Description:基础DAO，每个DAO都要继承此类</p>
* <p>创建日期:2012-11-28</p>
* @author ZhouChao
* @version 1.0
* <p>湖南家校圈科技有限公司</p>
...
public class BaseDao<T> {
	...
	public BaseDao(Context context) {
		...
		DBHelper dbHelper = new DBHelper(mContext, Configuration.DatabaseFile,
				null, Configuration.DatabaseVersion);
	...
	public Object queryField(Class<?> classz, String table, String[] columns, String selection,
		...
		if(c.moveToFirst()){
			try {
				if(classz == Integer.class) {   //int
					o = c.getInt(0);
				}else if(classz == String.class){   //String
					o = c.getString(0);
				}else if(classz == Long.class){   //long
					o = c.getLong(0);
				}else if(classz == Float.class){   //float
					o = c.getFloat(0);
				}else if(classz == Double.class){   //double
					o = c.getDouble(0);
				}else if(classz == Short.class){   //short
					o = c.getShort(0);
				}
			} catch (Exception e) {
